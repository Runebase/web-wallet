...
import CreateWallet from './controllers/Create.vue'
import CreateMnemonic from './controllers/CreateMnemonic.vue'
import RestoreWallet from './controllers/Restore.vue'
import RestoreWif from './controllers/RestoreWif.vue'
import RestoreMobile from './controllers/RestoreMobile.vue'
import RestoreKeyFile from './controllers/RestoreKeyFile.vue'
import RestoreLedger from './controllers/RestoreLedger.vue'
import ViewWallet from './controllers/View.vue'
import ViewTx from './controllers/ViewTx.vue'
import SafeSend from './controllers/SafeSend.vue'
import Send from './controllers/Send.vue'
import RequestPayment from './controllers/RequestPayment.vue'
import DumpKeyFile from './controllers/DumpKeyFile.vue'
import CreateContract from './controllers/CreateContract.vue'
import SendToContract from './controllers/SendToContract.vue'
import CallContract from './controllers/CallContract.vue'
import Config from './controllers/Config.vue'
import English from './locales/en.js'

import config from './libs/config.js'
import webWallet from './libs/web-wallet.js'
